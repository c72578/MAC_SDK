...
#define MAC_VERSION_STRING                              _T("4.33")
#define MAC_NAME                                        _T("Monkey's Audio 4.33")
#define PLUGIN_NAME                                     "Monkey's Audio Player v4.33"
#define MJ_PLUGIN_NAME                                  _T("APE Plugin (v4.33)")
#define CONSOLE_NAME                                    _T("--- Monkey's Audio Console Front End (v 4.33) (c) Matthew T. Ashland ---\n")
#define PLUGIN_ABOUT                                    _T("Monkey's Audio Player v4.33\nCopyrighted (c) 2000-2018 by Matthew T. Ashland")
